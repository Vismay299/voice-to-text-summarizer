...
Task { @MainActor in
    ...
    expect(KnownAppType.classify(bundleId: "com.mitchellh.ghostty") == .terminal, "Ghostty should be classified as terminal")
    ...
    expect(KnownAppType.classify(bundleId: "com.apple.dt.Xcode") == .plainTextEditor, "Xcode should be classified as plainTextEditor")
